/**
 * Created by Wangwei on 2019-03-26 11:50.
 */
...
func Get(url string, params map[string]interface{}) (respBody string, statusCode int, err error) {
...
func GetUrl(url string) (respBody string, statusCode int, err error) {
...
func GetUrlWithHeaders(url string, headers map[string]string) (respBody string, statusCode int, err error) {
